...
def pretreatment(data_pd):
    ...
    data_pd.to_csv(r'C:\Users\xiaojiu\Desktop\test\soc-sign-bitcoinotc-Pretreatment.csv',encoding="gbk",index=False)
    print("结束：", end='')
    print(time.asctime(time.localtime(time.time())))

pretreatment(pd.read_csv("soc-sign-bitcoinotc.csv"))